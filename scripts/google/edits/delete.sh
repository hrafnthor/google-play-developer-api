#!/usr/bin/env bash
#
# This script communicates with Google's Play Developer API to delete an ongoing
# edit.
#
# See more:
...
#   -e  EDIT_ID
#
#       [REQUIRED]  The edit id to delete.
...
if [[ ${HTTP_STATUS} != 204 ]]; then
    ...
    info "Body: $HTTP_BODY"
    error "Failed to delete edit ${EDIT_ID}. Exiting."
    exit 1
fi
