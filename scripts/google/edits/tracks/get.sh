#!/usr/bin/env bash
#
# This script queries Google's Play Developer API for specific track information.
#
# See more:
...
#
#       [REQUIRED]  The package name being uploaded, for example
#                   'com.company.appname'
#
...
#
#       [REQUIRED]  It is not clear what the edit id actual does in this case.
#
# -----------------------------------------------------------------------------
#
